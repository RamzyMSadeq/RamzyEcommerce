                            ...
                            if (submitForm()) {
                              ...
                              try {
                                ...
                                if (result.isNotEmpty &&
                                  ...
                                  User fiU = await AuthService.auth
...
class MyClippe extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(
        size.width / 4, size.height - 40, size.width / 2, size.height - 10);
    path.quadraticBezierTo(size.width - (size.width / 4), size.height + 15,
